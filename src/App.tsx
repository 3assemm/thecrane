import React, { useState, useEffect } from 'react';
    ...
    const App: React.FC = () => {
      ...
      return (
        <AuthProvider>
          <Router>
            <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 transition-colors duration-200">
              <Header 
                isDark={isDark} 
              ...
              <Routes>
                ...
                <Route path="/load-chart-comparison" element={<LoadChartComparison />} />
                <Route path="/report" element={<Report />} />
                <Route path="/html-report" element={<HtmlReportPage />} />
                <Route path="/admin" element={<Admin />} />
                <Route path="/admin/users" element={<UserManagement />} />
                <Route path="/dashboard" element={<Dashboard />} />
                <Route path="/calculations/:id/edit" element={<EditCalculation />} />
                <Route 
                  path="/help" 
