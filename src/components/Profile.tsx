            ...
            <div className="mb-8 p-4 bg-yellow-100 dark:bg-yellow-900 rounded-lg">
              <p className="text-yellow-800 dark:text-yellow-200">
                ...
                <button
                  ...
                  className="ml-2 underline hover:text-yellow-600 dark:hover:text-yellow-400 disabled:opacity-50"
                >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 dark:bg-gray-700 dark:text-white text-right"
                  dir="rtl"
                />
              </div>
              <button
